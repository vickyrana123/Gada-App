  ...
  return (
    <footer className='bg-dark text-light'
      ...
      <ul style={footerStyle}>
        ...
        <li style={listItemStyle}>
          <Link to="/Advertise" style={{ color: '#ffffff', textDecoration: 'none' }}>Advertise</Link>
        </li>
        <li style={listItemStyle}>
          <Link to="/Gift" style={{ color: '#ffffff', textDecoration: 'none' }}>Gift Cards</Link>
        </li>
        <li style={listItemStyle}>
          <Link to="/Help" style={{ color: '#ffffff', textDecoration: 'none' }}>Help Center</Link>
        </li>
        <li style={listItemStyle}>
